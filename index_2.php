...
//            } 
          ...
          ?>
          <fieldset>
            <form method="post" action="http://bean.co.ke/jubilee/thank_you.php">
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="policy">Choose your Jubilee Policy:</label>
              ...
              <div class="checkbox">
                ...
                <label><input type="checkbox" name="callback" value="callback" checked>I Agree you may contact me</label>
              </div>
