...
<html lang="en">
  <head>
    ...
    <!-- Google Code for Jubilee Medical Conversion Page -->
    <script type="text/javascript">
      // <![CDATA[ /
      var google_conversion_id = 946697369;
      var google_conversion_language = "en";
      var google_conversion_format = "3";
      var google_conversion_color = "ffffff";
      var google_conversion_label = "k3GmCLHi910Qmem1wwM";
  ...
  <div style="display:inline;">
    <img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/946697369/?label=k3GmCLHi910Qmem1wwM&amp;guid=ON&amp;script=0"/>
  </div>
  </noscript>
...
})(window,document,'script','dataLayer','GTM-W2L6W5');</script>
  ...
  <div class="container">
    ...
    <div class="col-md-8 col-sm-6">
      ...
      <div class="col-md-6 col-sm-12">
        ...
        <div id="discount">GET 5% DISCOUNT NOW!!</div>
    ...
    <div class="col-md-4 col-sm-6">
      <div id="lead-capture-form-thankyou">
        <?php
...
//          }
          ...
          try {
            ...
            $mail->AddReplyTo("salesonline@jubileekenya.com", "Jubilee Leads System");
            $mail->From = "salesonline@jubileekenya.com ";
            $mail->FromName = "Landing Page Leads";
            $to = 'salesonline@jubileekenya.com';
            //$to = 'pablo.nyaga@gmail.com'; 
            $mail->AddAddress($to);
            $mail->AddCC("wanjiku.kimani@jubileekenya.com", "Wanjiku Kimani");
            $mail->AddBCC('betty@bean.co.ke');
            $mail->AddBCC('martin@bean.co.ke');
            $mail->AddBCC('paul@xemplar.biz');
            $mail->Subject = "JCare Lead";
            $mail->AltBody = "To view the message, please use an HTML compatible email viewer!"; // optional, comment out and test
            $mail->WordWrap = 80; // set word wrap
            $mail->IsHTML(true);
            $mail->Body = '
              Below is a new lead from the Jubilee landing page:
              <br/><br/>
               <table border="1">
                <tr><td><b>Name:</b></td><td>'.$fullName.'</td></tr>
                <tr><td><b>Phone Number:</b></td><td>'.$phoneNumber.'</td></tr>
                <tr><td><b>Email:</b></td><td>'.$email.'</td></tr> 
                <tr><td><b>Policy selected:</b></td><td>'.$policy.'</td></tr>
                <tr><td><b>Agrees to Callback:</b></td><td>'.$callback.'</td></tr>
              </table>
              ';
            $mail->Send();
...
//              ':callback' => $callback));
          ...
          echo ' <center>';
          echo '  <font style="font-size: 21px">Thank you!<br/> Our sales team shall contact you. Visit our page to see more of our products</font><br/><br/><br/>';
          echo '   <a href="https://www.jubileeinsurance.com/ke/index.php/products-solutions" class="buttonSubmit" style="">Products & Services</a>';
          echo '  </center>';
        }
        ?>
